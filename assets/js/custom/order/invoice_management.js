$(document).ready(function(){    
	...
	load();
    $("body").on("change","#sort_by_fy",function(e){
        $(this).attr("selected");
        load() 
    });
    ...
    { 
        ...
        var sort_by_fy_obj = $('#sort_by_fy').find(":selected");
        var sort_by_fy_start_date=sort_by_fy_obj.attr("data-fy_start_date");
        var sort_by_fy_end_date=sort_by_fy_obj.attr("data-fy_end_date");
        var filter_string_search=$("#filter_string_search").val();
        // var is_scroll_to_top=$("#is_scroll_to_top").val(); 
        var data = "page="+page+"&filter_sort_by="+filter_sort_by+"&view_type="+view_type+"&sort_by_fy_start_date="+sort_by_fy_start_date+"&sort_by_fy_end_date="+sort_by_fy_end_date+"&filter_string_search="+filter_string_search;
        // alert(data);// return false;
        $.ajax({
            url: base_URL+"order/get_invoice_management_list_ajax/"+page,
            data: data,
            cache: false,
            method: 'GET',
            dataType: "html",
    ...
    $("body").on("click","#download_invoice_management_csv",function (e){
        var base_URL     = $("#base_url").val();
        var filter_sort_by=$("#filter_sort_by").val();                
        var sort_by_fy_obj = $('#sort_by_fy').find(":selected");
        var sort_by_fy_start_date=sort_by_fy_obj.attr("data-fy_start_date");
        var sort_by_fy_end_date=sort_by_fy_obj.attr("data-fy_end_date");
        var filter_string_search=$("#filter_string_search").val();
        var data = "filter_sort_by="+filter_sort_by+"&sort_by_fy_start_date="+sort_by_fy_start_date+"&sort_by_fy_end_date="+sort_by_fy_end_date+"&filter_string_search="+filter_string_search;
       
        document.location.href = base_URL+'order/download_invoice_management_csv/?'+data;
    });
