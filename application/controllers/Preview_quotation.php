...
class Preview_quotation extends CI_Controller {	
    ...
    {	
    	...
    	{ 
    		...
    		//echo $opportunity_id.'-'.$quotation_id.'-'.$client_id; die('ok');
			...
			$tmp_download_str=base64_encode(rand().'#'.$opportunity_id.'#'.$quotation_id.'#'.$client_id.'#'.rand().'#12');
			$download_url=base_url('download/quotation/'.$tmp_download_str);
