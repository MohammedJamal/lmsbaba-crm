    ...
    */
    ...
    {        
        ...
        if($this->post('token'))
        {
            ...
            if($user_id!='' && $source_id!='' && $assigned_user_id!='')
            {
                if($customer_id==''){
                    
                    if(($mobile!='' || $email!='') && $contact_person!='' && $company_name!='' && $country_id!=''){
                       ...
                       $customer_id=$this->customer_model->CreateCustomer($company_data,$client_info);
                ...
                if($customer_id!=''){
                    ...
                    if($lead_id)
                    {
                        ...
                        $comment_title=NEW_LEAD_CREATE_MANUAL_APP;
                        $historydata=array(
                                            'title'=>$comment_title,
                                            'lead_id'=>$lead_id,
