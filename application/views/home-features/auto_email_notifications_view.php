      ...
      <div class="row align-items-center">
         ...
         <div class="col-lg-12">
            <div class="text-left mb-4">
                <h2>Auto Email Notifications</h2>
                
            </div>
         </div>
         <div class="col-lg-12">
            <div class="text-black">
                <span class="problem-txt"><strong>Problem Statement:</strong> Every individual in sale team may not have correct email writing skills.</span><br><br>
                
                Written communication plays big role in lead to business conversion and building brands. But at the same time it is time consuming a well as employees may not have good email writing skills. Also nonstandard communication dent the company’s image too. LMSBaba™ sends well written emails automatically on different instances like New Lead Received, Change of Relationship Manager, Sending Quotation, Order Received, Lead Regretted etc. This is completely in admin’s control and can be customized if required. This helps in making company brand value and save time to write standard commination email. 
