      ...
      <div class="row align-items-center">
         ...
         <div class="col-lg-12">
            <div class="text-left mb-4">
                <h2>Lead Follow Up Alerts</h2>
                
            </div>
         </div>
         <div class="col-lg-12">
            <div class="text-black">
                <span class="problem-txt"><strong>Problem Statement:</strong> Buyers expect timely follow up by the sellers but because of lack of any tool & huge sales pressure, sale team missing timely follow ups  and ultimately competitors get chance snatch your buyers.</span><br><br>
                
                Timely follow up with the buyers is one of the most important keys of lead maturity but it is very difficult to manage without any digital solution. Here, LMSBaba™ is having solution set follow up reminders along with date & time and it alerts you as soon land on the dashboard. LMSBaba™ is scalable to send follow up alerts on Whatsapp, SMS & Email by using 3rd party APIs. 
