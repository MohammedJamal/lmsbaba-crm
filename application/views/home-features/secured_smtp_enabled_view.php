      ...
      <div class="row align-items-center">
         ...
         <div class="col-lg-12">
            <div class="text-left mb-4">
                <h2>Secured SMPT Enabled</h2>
                
            </div>
         </div>
         <div class="col-lg-12">
            <div class="text-black">
                <span class="problem-txt"><strong>Problem Statement:</strong> Need technical knowhow for email sending integration. Also management is difficult without tech-team.</span><br><br>
                
                SMTP (Simple Mail Transfer Protocol) is an email sending & receiving technology used to send auto email messages without using compose box. LMSBaba™ CRM enables you to set your SMTP with easiest way. LMSBaba™ team helps you to get it implemented. After enabling SMTP, all auto email notification to your customers will be delivering from your email id. Also all email transactions from LMSBaba™ CRM will start getting saved in your sent box. 
