      ...
      <div class="row align-items-center">
         ...
         <div class="col-lg-12">
            <div class="text-left mb-4">
                <h2>Whatsapp, Calls & Email Communication</h2>
                
            </div>
         </div>
         <div class="col-lg-12">
            <div class="text-black">
                <span class="problem-txt"><strong>Problem Statement:</strong> For every communication medium sales team have to use separate tools or gadget.</span><br><br>
                
                LMSBaba™ Lead Board is very user friendly and easy to adopt. Every leads is presented in a way so that sales person can easily find all communication mediums in single screen. There are three most used mediums to connect with the buyers -  Phone calls, Whatsapp messaging & Emails. Sales person can use all three mediums very easily.<br><br>

                <strong>Phone Calls:</strong> LMSBaba™ android APP enables you to call a buyer without saving or dialing a number. You just need to click on Phone Icons and you will get notification on LMSBaba™ App to make SIM / Whatsapp calls with buyer’s name & contact number. <br><br>

                <strong>Whatsapp Messages:</strong> You can send Whatsapp messages to the buyers without saving the buyers’ mobile number in contact list. You just need to click on Whatsapp icon and type your message which you want to send to the buyer. As soon you will click on submit button, it will open your Web Whatsapp and print the same message in message box to send.<br><br>

                <strong>Email Communication:</strong> You can send emails to the buyers by clicking on reply icon. You can type your message or select pre-define messages to send email.
