      ...
      <div class="row align-items-center">
         ...
         <div class="col-lg-12">
            <div class="text-black">
                <span class="problem-txt"><strong>Problem Statement:</strong> Sales find difficulty to get analytical report as & when required which become hurdle for faster growth.</span><br><br>
                
                LMSBaba™ provides pictorial view of Dashboard which contains critical reports that lead to forecast sales productivity. Sales manager can track their team’s performance on run time as well as the marketing efforts to generate qualified leads. Tracking sales pipeline is very important for any organization to get maximum sales output. LMSBaba™ dashboard gives various insights of data in form of charts and comparative tabular format. Lead generation to closer reports are available hands-on. Browsing individual’s performance or team performance in desire period can be easily analyzed. Data can be downloaded for further analysis. 
