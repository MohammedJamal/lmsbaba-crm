      ...
      <div class="row align-items-center">
         ...
         <div class="col-lg-12">
            <div class="text-left mb-4">
                <h2>Quick Quotation Builder</h2>
                
            </div>
         </div>
         <div class="col-lg-12">
            <div class="text-black">
                <span class="problem-txt"><strong>Problem Statement:</strong> Building Quotations are very time consuming. Manual creation of quotation cannot be error proof thus requires multilevel approvals.</span><br><br>
                
                LMSBaba™ quotation builder is one of the best features which enable users to create an error free quotation in less than one minute. It allows to make multi-dimensional quotation such as:<br>

                <ul class="default-ul">
                    <li>Auto capturing buyer’s information in quotation</li>
                    <li>Multi-products/services quotation builder</li>
                    <li>Building price-list in the form of quotation</li>
                    <li>Multi-currency quotation</li>
                    <li>Auto calculation of GST/CGST/SGST/IGST</li>
                    <li>Auto Calculation of discount offers</li>
                    <li>Product images inclusion in PDF quotation</li>
                    <li>Video link inclusion with in PDF quotation</li>
                    <li>Selection of pre-defined terms & conditions</li>
                    <li>Dynamic start & end quotation note</li>
                    <li>Sending quotation through mail & Whatsapp</li>
                    <li>Option to download PDF quotation</li>
                </ul>
