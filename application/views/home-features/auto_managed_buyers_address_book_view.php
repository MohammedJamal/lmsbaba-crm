      ...
      <div class="row align-items-center">
         ...
         <div class="col-lg-12">
            <div class="text-left mb-4">
                <h2>Auto Managed Buyer’s Address Book</h2>
                
            </div>
         </div>
         <div class="col-lg-12">
            <div class="text-black">
                <span class="problem-txt"><strong>Problem Statement:</strong> Most of the lead generation platforms send leads in your email. Making buyers database from mailbox is very cumbersome & time taking task to maintain.</span><br><br>
                
                You no need to create your buyers’ address book. LMSBaba™ AI module automatically identifies your buyer’s details from your lead creation and create address book for your re-marketing plans. You can further enrich address book with Buyer’s GST, PAN, alternate emails, mobiles etc. Buyer’s Address Book is asset for a company and only repository of organizations success. You may download the company data and do your marketing activities for further lead generation.
