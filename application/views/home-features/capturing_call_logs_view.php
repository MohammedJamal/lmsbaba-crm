      ...
      <div class="row align-items-center">
         ...
         <div class="col-lg-12">
            <div class="text-left mb-4">
                <h2>Capturing Call Logs</h2>
                
            </div>
         </div>
         <div class="col-lg-6">
            <div class="text-black">
                <span class="problem-txt"><strong>Problem Statement:</strong> Direct calls from new buyers or existing buyers or sales business calls from the buyers get stuck with user’s mobile call log. That leads to missing business opportunities.</span><br><br>
                
                Today, mobile has become the fastest medium to do the business. Buyer’s direct calls to supplier is one of the important source of leads. LMSBaba™’s <strong>Call Logs to Leads</strong> feature enables users to sync their call logs to LMSBaba™ CRM through LMSBaba™ Android App. With your permission, LMSBaba™ App auto sync your incoming and outgoing calls with the time talk time duration and display on call log report. You can mark your personal calls in the App which will get restrict to sync those calls. <br><br>
