      ...
      <div class="row align-items-center">
         ...
         <div class="col-lg-12">
            <div class="text-left mb-4">
                <h2>Customized Lead Staging/Pipeline</h2>
                
            </div>
         </div>
         <div class="col-lg-6">
            <div class="text-black">
                <span class="problem-txt"><strong>Problem Statement:</strong> Difficulty in finding leads by sales team so that they can identify the most prospect and less prospect leads. Ultimately effort & time loss cause less conversion.</span><br><br>
                
                Every business has its own process and stages to manage leads. All the leads what you receive do not have potential leads and may not be potential to get converted into business. LMSBaba™ enables you to filter your prospects to get focused output. Now prospect leads having different stages which vary business to business. LMSBaba™ enables you define your own lead pipeline and tag with the lead in just one click. You can filter leads as per your need for close monitoring. You can make any number of your lead stages so that you can identify your leads in couple of clicks that which lead is in which stage.
