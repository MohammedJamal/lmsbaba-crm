      ...
      <div class="row align-items-center">
         ...
         <div class="col-lg-12">
            <div class="text-left mb-4">
                <h2>Click to Call Service Enabled</h2>
                
            </div>
         </div>
         <div class="col-lg-12">
            <div class="text-black">
                <span class="problem-txt"><strong>Problem Statement:</strong> It is difficult to track calls made by sales team and listen call recordings to improve sales quality & training to the team.</span><br><br>
                
                Calling a customer become very easy through click to call process on LMSBaba™. You just need to click on call button and it will connect you with your buyer. At the same time system will record all conversation for your future reference.   Please note that Click to Call API is a 3rd party service & LMSBaba™ will enables you  to integrate your API Key. 
