      ...
      <div class="row align-items-center">
         ...
         <div class="col-lg-12">
            <div class="text-left mb-4">
                <h2>Business Whatsapp API Enabled</h2>
                
            </div>
         </div>
         <div class="col-lg-12">
            <div class="text-black">
                <span class="problem-txt"><strong>Problem Statement:</strong> Sending auto messages on Whatsapp is not possible so sending transactional messages to the client on Whatsapp is quite tedious and time taking.</span><br><br>
                
                Whatsapp has become a lifeline for businesses so they want automation in Whatsapp. Only Whatsapp API business account can be configured with auto messaging on different instances. But getting the Whatsapp API integration, you need to get a big size software developed. Here LMSBaba™ CRM enables you to get auto messaging on Whatsapp. You can setup notifications on various transaction like Lead acknowledgement, quotations, proposals & performa invoice etc. Please note that Whatsapp Business API is a 3rd party service & LMSBaba™ will enables you  to integrate your API Key. <br><br>
