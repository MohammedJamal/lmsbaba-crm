      ...
      <div class="row align-items-center">
         ...
         <div class="col-lg-12">
            <div class="text-black">
                <span class="problem-txt"><strong>Problem Statement:</strong> All sensitive information are visible to all employees which is threat to data theft.</span><br><br>
                
                LMSBaba™ provide user’s permission management module which allows admin to set permission for users and give access to only those modules which are required to them for business development. Telesales Representative may not require to see  buyer’s data base or purchase order register so admin can withdraw the permission. Admin can also block / unblock any users to access LMSBaba™ login in just a single click.
