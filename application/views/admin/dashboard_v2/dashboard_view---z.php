            ...
            <!-- new dashboard start -->
               ...
               <div class="row mb-30">
                  ...
                  <div class="col-md-4">
                     <div class="white-box pa-0 same-height">                                              
                        ...
                        <div class="w-new-header justify-content-center text-uppercase">
                           Financial Review
                        </div>  
                     </div>
                  </div>
                  ...
                  <div class="col-md-4">
                     <div class="white-box pa-0 same-height three-chart-height">
                        <div class="w-chart-holder pb-0 pt-10" id="show_leads_opportunity_data">
                        </div>
                        <div class="w-new-header justify-content-center text-uppercase">
                           Lead Generation
                        </div>
               ...
               <div class="row mb-30">
                  <div class="col-md-12">
                     <div class="white-box">
                        ...
                        <div id="show_sales_pipeline_data">
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <div class="row mb-30">
                  <div class="col-md-12">
                     <div class="white-box">
                        ...
                        <div id="show_user_activity_report_data">
                        </div>
               ...
               <div class="row mb-30">
                  <div class="col-md-12">
                     <div class="white-box">
                        ...
                        <div id="show_daily_sales_report_data">
                        </div>
               ...
               <div class="row mb-30">
                  <div class="col-md-6">
                     <div class="white-box">
                        <div class="table-tile">
                           <h2 class="text-uppercase">Top Selling Produts <br><small id="show_daterange_html_tsp" class="pull-left">( All Time )</small></h2>
                           <ul class="pull-right right">                  
                              <li>  
                        ...
                        <div id="show_top_selling_produts">
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-md-6">
                     <div class="white-box">
                        <div class="table-tile">
                           <h2 class="text-uppercase">latest sales orders</h2>
                        </div>
 ...
 $(document).ready(function(){  
    ...
    checkCount = function(){
      ...
      if(loadCount == 3){
         ...
         $('#show_top_selling_produts').parent().css({'height': hA+'px'}).addClass('sporel');
         $('#show_latest_sales_orders').parent().css({'height': hA+'px'}).addClass('sporel-987');
      }
    }
