               ...
               <div class="row mb-30">
                  ...
                  <div class="col-md-4">
                     <div class="white-box pa-0 same-height">                                                                     
                        <div class="w-chart-holder ajax-content" id="show_financial_review_data"></div>                        
                  ...
                  <div class="col-md-4">
                     <div class="white-box pa-0 same-height two-chart-height">                        
                        <div class="w-chart-holder pb-0 pt-10 fix-height-256 ajax-content" id="show_sales_orders_data"></div>   
                  ...
                  <div class="col-md-4">
                     <div class="white-box pa-0 same-height three-chart-height">                        
                        <div class="w-chart-holder pb-0 pt-10 ajax-content" id="show_leads_opportunity_data"></div>                                                
               ...
               <div class="row mb-30">
                  <div class="col-md-12">
                     <div class="white-box">
                        ...
                        <div class="ajax-content" id="show_sales_pipeline_data"></div>
               ...
               <div class="row mb-30">
                  <div class="col-md-12">
                     <div class="white-box">
                        ...
                        <div id="show_user_activity_report_data" class="ajax-content"></div>
                        <div class="footer-table">
                           <div class="footer-right">
               ...
               <div class="row mb-30">
                  <div class="col-md-12">
                     <div class="white-box">
                        ...
                        <div id="show_daily_sales_report_data" class="ajax-content"></div>
                        <div class="footer-table">
                           <div class="footer-right">
               ...
               <div class="row mb-30">
                  <div class="col-md-12">
                     <div class="white-box">
                        ...
                        <div id="show_lead_by_source_report_data" class="ajax-content"></div>
                        <div class="footer-table">
                           <div class="footer-right">
               ...
               <div class="row mb-30">
                  <div class="col-md-6">
                     <div class="white-box">
                           ...
                           <ul class="pull-right right">                  
                              <li>  
                                 <select class="blue-select min-w-200" id="date_range_pre_define_tsp">
                                    ...
                                    <option value="LAST12MONTHS" data-text="Last 1 Year" selected="">Last 1 Year</option>
                                    <option value="TILLDATE" data-text="All Time" >All Time</option>
                                 </select>      
                              </li>
                              <li>
                        ...
                        <div id="show_top_selling_produts" class="ajax-content"></div>
                     </div>
                  </div>
                  ...
                  <div class="col-md-6">
                     <div class="white-box">
                        ...
                        <div id="show_latest_sales_orders" class="ajax-content">
                        </div>
               ...
               <div class="row mb-30">
                  <div class="col-md-4">
                     <div class="white-box">
                        ...
                        <div id="lead_by_source_div" class="ajax-content"></div>  
                        <div class="footer-table">
                           <div class="footer-right">
                  ...
                  <div class="col-md-4">
                     <div class="white-box">
                        ...
                        <div id="lead_by_lost_reasons_div" class="ajax-content"></div> 
                        <div class="footer-table">
                           <div class="footer-right">
                  ...
                  <div class="col-md-4">
                     <div class="white-box">
                        ...
                        <div id="lead_by_unfollowed_div" class="ajax-content"></div>
                        <div class="footer-table">
                           <div class="footer-right">
               ...
               <div class="row mb-30">
                  <div class="col-md-12">
                     <div class="white-box">
                        ...
                        <div class="w-100 ajax-content" id="show_top_performers_of_month_data"></div>
                     </div>
                  </div>
               </div>
...
<script src="<?php echo assets_url();?>js/jquery.inview.js"></script>
...
// return new Date(year, month+1, 0).getDate();
 ...
 $(document).ready(function(){  
   ...
   $('div').on('inview', function(event, isInView) {
      if (isInView) {    
         //ajax-content
         if($(this).hasClass('ajax-content') && !$(this).hasClass('loaded')) {
            var getid = $(this).attr('id');
            // console.log('*********************');
            // console.log(getid);
            // console.log('*********************');
            $(this).addClass('loaded');
            if(getid == 'show_financial_review_data'){
               load_financial_review();
            }
            if(getid == 'show_sales_orders_data'){
               load_sales_orders();
            }
            if(getid == 'show_leads_opportunity_data'){
               load_leads_opportunity();
            }
            //show_sales_pipeline_data
            if(getid == 'show_sales_pipeline_data'){
               load_sales_pipeline(1);
            }
            //show_user_activity_report_data
            if(getid == 'show_user_activity_report_data'){
               load_user_activity_report_v2(1);
            }
            //show_daily_sales_report_data
            if(getid == 'show_daily_sales_report_data'){
               load_daily_sales_report_v2(1);
            }
            //show_lead_by_source_report_data
            if(getid == 'show_lead_by_source_report_data'){
               load_lead_by_source_report();
            }
            //show_top_selling_produts
            if(getid == 'show_top_selling_produts'){
               load_top_selling_produts();
            }
            //show_latest_sales_orders
            if(getid == 'show_latest_sales_orders'){
               load_latest_sales_orders();
            }
            //lead_by_source_div
            if(getid == 'lead_by_source_div'){
               load_leads_by_source();
            }
            //lead_by_lost_reasons_div
            if(getid == 'lead_by_lost_reasons_div'){
               load_lead_lost_reasons();
            }
            //lead_by_unfollowed_div
            if(getid == 'lead_by_unfollowed_div'){
               load_unfollowed_leads_by_users();
            }
            //show_top_performers_of_month_data
            if(getid == 'show_top_performers_of_month_data'){
