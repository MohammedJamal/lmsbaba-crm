        ...
        <?php 
            ...
            { 
                ...
                <tr>
                    ...
                    <td><span class="text-xs font-weight-bold"><a href="JavaScript:void(0)" class="tag_assign_form_popup" data-stage_id="<?php echo $row['id']; ?>"><?php echo ($row['assigned_user_name'])?$row['assigned_user_name']:'-'; ?></a></span></td>
                    <td class="align-middle" class="text-center">
                        <span class="text-xs font-weight-bold">
                            <a href="JavaScript:void(0)" class="tag_assign_form_popup" data-stage_id="<?php echo $row['id']; ?>"><i class="fa fa-tags" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;
                            <a href="JavaScript:void(0)" class="untag_assign_form_popup" data-stage_id="<?php echo $row['id']; ?>"><i class="fa fa-chain-broken" aria-hidden="true"></i></a>
                        </span>
                    </td>                         
                </tr>
                <?php 
