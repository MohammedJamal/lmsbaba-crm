<div class="col-md-12">
    <fieldset class="scheduler-border">
        ...
        <div class="control-group">
            <div class="form-row">
                <div class="col-md-4">
                    <label for="om_stage_name">Stage Name:</label>
                    <input type="text" class="form-control " name="om_stage_name" id="om_stage_name" placeholder="" value="" maxlength="255" >
                </div>
                <div class="col-md-3">
                    <label for="om_stage_position">Stage Position:</label>
                    <select class="form-control" name="om_stage_position" id="om_stage_position">
                ...
                <div class="col-md-4">
                    <label for="om_stage_id">Stage Stage:</label>
                    <select class="form-control" name="om_stage_id" id="om_stage_id">
                        <option value="">-- Select --</option>
                        <?php if(count($rows)){ ?>
                ...
                <div class="col-md-1">
                    <a href="javascript:void(0)" class="btn btn-success mt-25" id="om_stage_add_submit">Add</a>
                </div>
            </div>
