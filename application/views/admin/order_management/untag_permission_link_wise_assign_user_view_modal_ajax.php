        ...
        <?php 
            ...
            { 
                ...
                {           
                    $i++;
                ?>
                <tr id="div_link_<?php echo $row['id']; ?>">                                          
                    <td><span class="text-xs font-weight-bold"> <?php echo $row['name']; ?> </span></td> 
                    <td class="align-middle text-center">
                        <span class="text-xs font-weight-bold">
                            <a href="JavaScript:void(0)" class="untag_permission_link_wise_assign_user_popup_confirm text-red" data-user_id="<?php echo $row['id']; ?>" data-permission_link_id="<?php echo $permission_link_id; ?>"><i class="fa fa-trash-o" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;
                        </span>
                    </td>                         
                </tr>
                <?php 
