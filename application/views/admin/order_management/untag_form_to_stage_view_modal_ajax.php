        ...
        <?php 
            ...
            { 
                ...
                {           
                    $i++;
                ?>
                <tr id="div_form_<?php echo $row['id']; ?>">                                          
                    <td><span class="text-xs font-weight-bold"> <?php echo $row['name']; ?> </span></td> 
                    <td class="align-middle text-center">
                        <span class="text-xs font-weight-bold">
                            <a href="JavaScript:void(0)" class="untag_assign_form_popup_confirm text-red" data-form_id="<?php echo $row['id']; ?>" data-stage_id="<?php echo $stage_id; ?>"><i class="fa fa-trash-o" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;
                        </span>
                    </td>                         
                </tr>
                <?php 
