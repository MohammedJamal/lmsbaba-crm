<div class="color-box-with-border">
    <div class="w-100"> 
        <h2 class="sm">Order Approval Status</h2>
        <?php if(count($form_wise_field_list)){ $i=0;?>
            <?php foreach($form_wise_field_list AS $field){ ?>
                ...
                <div class="col-md-full">
                    ...
                    <label class="bold-label"><?php echo $field['label']; ?>: <?php echo ($field['is_mandatory']=='Y')?'<apan class="text-red">*</span>':''; ?></label>
                    ...
                    <?php if($field['input_type']=='F'){?>
                        ...
                        <input type="file" class="<?php echo $required_str; ?> om_custom_form_field" name="<?php echo $field['input_type'].'_'.$field['form_id'].'_'.$i; ?>" data-id="<?php echo $field['id']; ?>" data-label="<?php echo $field['label']; ?>">
                    <?php } ?>
