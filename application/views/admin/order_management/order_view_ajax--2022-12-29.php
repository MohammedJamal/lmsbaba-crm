            ...
            <li>
                <div class="sortable_head">
                    ...
                    <div class="heading-info">
                        ...
                        <div><a href="JavaScript:void(0);" class=""><i class="fa fa-search" aria-hidden="true"></i></a></div>
                    </div>
                </div>
                    ...
                    <div class="ui-state-default custom-white-card" id="<?php echo $pi_list['id']; ?>" data-sid="<?php echo $stage_list['id']; ?>">
                        ...
                        <div class="sortable_order_dot">
                            <ul class="d-inline-flex">
                                <li class="pr-5px">                                
                                    <a class="change_status_order change_priority <?php echo ($pi_list['pi_priority']=='2')?'active':''; ?>" href="JavaScript:void(0);" data-po_pi_wise_stage_tag_id="<?php echo $pi_list['om_po_pi_wise_stage_tag_id']; ?>">
                                ...
                                <li>
                                    <div class="dropdown">
                                        <button class="dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <img src="<?php echo assets_url()?>images/menu-dot.svg">
                                        </button>
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a href="JavaScript:void(0)" class="get_om_detail dropdown-item" data-lowp="<?php echo $pi_list['lead_opportunity_wise_po_id']; ?>" data-pfi="<?php echo $pi_list['id']; ?>" data-stageid="<?php echo $stage_list['id']; ?>" data-po_pi_wise_stage_tag_id="<?php echo $pi_list['om_po_pi_wise_stage_tag_id']; ?>">View Detail</a>
