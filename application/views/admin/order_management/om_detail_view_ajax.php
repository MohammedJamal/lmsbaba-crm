...
<div class="card-block">
    ...
    <div class="row">        
        <div class="col-md-9"> 
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="badge bg-success show_tooltip" href="JavaScript:void(0);" onClick="copy_text('<?php echo $po_register_info->cust_assigned_user_mobile; ?>')" title="<?php echo $po_register_info->cust_assigned_user_mobile; ?><br><i><font color='red'>Click to Copy</font></i>" data-title="Mobile" data-mobile="<?php echo $po_register_info->cust_assigned_user_mobile; ?>"><i class="fa fa-phone" aria-hidden="true"></i></a>
                                    <?php } ?>
                                    <?php if($po_register_info->cust_assigned_user_email){ ?>
                                    <a class="badge bg-success show_tooltip"  href="JavaScript:void(0);" onClick="copy_text('<?php echo $po_register_info->cust_assigned_user_email; ?>')" title="<?php echo $po_register_info->cust_assigned_user_email; ?><br><i><font color='red'>Click to Copy</font></i>"><i class="fa fa-envelope-o" aria-hidden="true"></i></a>
                                    <?php } ?>
                                </td>
                            </tr>                  
                        </tbody>
            ...
            <?php */ ?>
            <div class="border-block">
                <div class="instructions-title"><span>Expected Delivery Date:</span> <?php echo ($po_register_info->pro_forma_expected_delivery_date!='' && $po_register_info->pro_forma_expected_delivery_date!='0000-00-00')?date_db_format_to_display_format($po_register_info->pro_forma_expected_delivery_date):'N/A'; ?></div>
            </div>
            ...
            <div class="border-block no-border">
                ...
                <ul class="auto-ul">
                    <?php if($is_quotation_link_available==true){ ?>
                    <li>                        
                    <?php 
                    ...
                    if($po_register_info->q_is_extermal_quote=='N'){ ?>
                        ...
                        <a class="set_history_from_link" data-pfi="<?php echo $pfi; ?>" data-history_text="The PDF quotation has been downloaded" href="<?php echo base_url($this->session->userdata['admin_session_data']['lms_url'].'/opportunity/preview_quotation/'.$po_register_info->lo_id.'/'.$po_register_info->q_id);?>" target="_blank">Quotation</a>
                    <?php 
                    ...
                    <?php } ?>
                    <?php if($is_purchase_order_link_available==true){ ?>
                    ...
                    <?php if($is_proforma_invoice_link_available==true){ ?>
                    <?php
                    ...
                    { 
                        ...
                        $proforma_download_url=base_url($this->session->userdata['admin_session_data']['lms_url'].'/order/preview_pro_forma_inv/'.$po_register_info->id);
                    }
                    else{
                    ...
                    <?php if($is_invoice_link_available==true){ ?>
                    <?php 
                    $inv_download_url='';
                    ...
                    { 
                        ...
                        $inv_download_url=base_url($this->session->userdata['admin_session_data']['lms_url'].'/order/preview_invoice/'.$po_register_info->id);
                    }
                    else{
                    ...
                    ?>
                    <?php if($inv_download_url!='' && $po_register_info->invoice_no!=''){ ?>
                    ...
                    <?php if($is_payment_ledger_link_available==true){ ?>
                    <li><a href="JavaScript:void(0)" class="om_view_payment_ledger" data-lowp="<?php echo $po_register_info->id; ?>">Payment Ledger</a></li>
                    <?php } ?>
                    <li><a href="JavaScript:void(0);" id="view_deliverables" data-lowp="<?php echo $lowp; ?>" data-pfi_split_id="<?php echo $pfi_split_id; ?>">Deliverables</a></li>
        ...
        <div class="row">
            <div class="col-md-6">
            <form id="omUpdateCommentFrm" name="omUpdateCommentFrm">
            <div class="border-block no-border">
               <h2>Update Comment<span class="red">*</span></h2>
               <div class="order_status_txt">
                  <textarea class="default-textarea mb-15" name="om_comment" id="om_comment"></textarea>
                  <div class="row">
                       <div class="col-md-9">
                            <!-- <label class="uploaded-doc">
                       ...
                       <div class="col-md-3">
                           <button class="btn btn-primary pull-right fix-ww" id="om_update_comment_confirm">Submit</button>
                       </div>
                   </div>
               </div>
            ...
            <hr>
                <form id="omDocFrm" name="omDocFrm" class="">
                    ...
                    <input type="hidden" name="po_pi_wise_stage_tag_id" id="po_pi_wise_stage_tag_id" value="<?php echo $po_pi_wise_stage_tag_id; ?>" />
                    <input type="hidden" name="pfi_split_id" id="pfi_split_id" value="<?php echo $pfi_split_id; ?>" />
                    <div class="border-block no-border">
                        ...
                        <div class="order_status_txt">
                                <div class="control-group">
                                        <div class="form-row">                                
                                            ...
                                            <div class="col-md-12">
                                                <div class="sp-containt-holder" id="om_form_wise_fields_div"></div>
                                            </div>                                
                                        </div>                    
                                </div> 
                        </div>               
...
$(document).ready(function(e){
    ...
    if($("#proforma_invoice_id").val()){
        ...
        fn_rander_document_list(piid,pfi_split_id);
    }
...
function fn_rander_document_list(proforma_id='',pfi_split_id='')
{
    var base_url=$("#base_url").val();    
    $.ajax({
