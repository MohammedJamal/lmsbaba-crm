<?php if(count($rows)){ ?>
	<?php foreach($rows as $row){ ?>
		...
		?>
		<tr>
			<td><?php echo ($group_by=='D')?date_db_format_to_display_format($row->date_str):$row->date_str; ?></td>
	...
	<?php } ?>
<?php }else{ ?>
	<tr><td colspan="<?php echo (9+count($currency_list)); ?>">No Daily Sales Report  available.</td></tr>
<?php } ?>