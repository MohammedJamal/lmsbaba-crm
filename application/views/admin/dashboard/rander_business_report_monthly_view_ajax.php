...
<?php if(count($rows)){ ?>
	<?php foreach($rows as $row){ ?>
		<tr>
			<th scope="row"><?php echo $row->date_str; ?></th>
			...
			<td><a class="revenue_btn" href="details_<?php echo $cid; ?>"></a></td>			
		</tr>
		<tr class="hide_details" id="details_<?php echo $cid; ?>">
			<th colspan="8">
			<ul class="details_ul">
...
<?php }else{ ?>
		<tr class="no-border-bottom">
			<th colspan="8"><div class="no-record monthly">No record found..</div></th>
		</tr>
<?php } ?>