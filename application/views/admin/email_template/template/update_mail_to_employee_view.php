            ...
            <tr>
                <th class="flex" width="300" align="left" style="padding:0;">
                    <table class="center" cellpadding="0" cellspacing="0">
                        <tr>
                            <td>
                                <h4 style=" color: #444343;font-weight: 200; font-size: 16px; margin-bottom: 0; margin-top:15px;"><?php echo $company['name']; ?></h4>
                                <div>
                                    <p style="width: 100%; float: left; color: #444343;font-size: 13px; margin: 0px; margin-top: 4px; margin-bottom: 10px;font-weight:300;"><?php if(trim($company['city_name'])){echo $company['city_name'].',';}?>
                            ...
                            <td style="padding:0px 15px; background: #fff">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="background:#BDD6EE;font-weight: 300;">Quotation</th>
                                        <th style="background:#BDD6EE;font-weight: 300;">Last Updated On</th>
                                        <th style="background:#BDD6EE;font-weight: 300;">Lead Type</th>
                                        <th style="background:#BDD6EE;font-weight: 300;">Lead Status</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="font-size: 13px;text-align: center"><?php echo get_company_name_initials(); ?> - <?php echo $lead_info->id; ?></td>
                                        <td style="font-size: 13px;text-align: center"><?php echo $get_quotation_count; ?></td>
                                        <td style="font-size: 13px;text-align: center">
                                          <?php echo date_db_format_to_display_format($last_lead_comment->create_date); ?>
                                        </td>
                                        <td style="font-size: 13px;"><?php if($lead_info->current_stage=='PENDING'){echo 'IN PROCESS';}else{echo $lead_info->current_stage;} ?></td>
                                        <td style="font-size: 13px; text-align: center"><?php echo $lead_info->current_status; ?></td>
    ...
    <tr>
        <td data-bgcolor="bg-module" bgcolor="#fff">
            <table width="600" align="center" style=" background: #ccc; padding: 0px 20px 0px; margin:0 auto;" cellpadding="0" cellspacing="0">
              ...
              <center><h2 style="font-size: 16px; font-weight: 300; color: #227ef0; margin-top: 0px;"><?php echo ($assigned_to_user['gender']=='M')?'Mr.':'Ms.'; ?> <?php echo $assigned_to_user['name']; ?> has updated the enquiry # <?php echo get_company_name_initials(); ?> - <?php echo $lead_info->id; ?></h2></center>
            </tr>
            <tr>
                <td align="left" style="color:#292c34; font-size: 13px; padding-bottom:20px;">
                   <b>Company Name:</b> <?php echo $customer->company_name; ?><br>
                   <b>Contact Person:</b> <?php echo $customer->contact_person; ?><br>
                   <b>Country:</b> <?php echo $customer->country_name; ?>
                </td>
            </tr>
            <tr>
                <td align="left" style="color:#555; line-height: 16px; text-align: justify;">
                <p style="font-weight: 400; color: #3e3737; font-size: 13px; margin-top: 8px; margin-bottom: 8px;"><b>Comment:</b><br>
                    <?php echo $updated_comments; ?></p>
                </td>
            </tr>
        ...
        <td data-bgcolor="bg-module" bgcolor="#fff">
            <table width="600" align="center" style="margin:0 auto;" cellpadding="0" cellspacing="0">
             <tr style="padding-top:5px;">    
                    <td align="right">
                    <?php /* ?><p style="margin: 4px 0; line-height: 14px; font-size: 9px; color: #888; ">Powered By: <a href="https://lmsbaba.com/" target="_blank" style="color: #888;">LMSbaba.com</a></p><?php */ ?>
                    </td>
                    </tr>
            </table> 
        </td>
