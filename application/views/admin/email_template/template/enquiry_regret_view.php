                            ...
                            <td style="padding:0px 15px; background: #fff">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="font-size: 13px;">REGRETTED</td>
    ...
    <tr>
        <td data-bgcolor="bg-module" bgcolor="#fff">
            <table width="600" align="center" style=" background: #ccc; padding: 0px 20px 0px; margin:0 auto;" cellpadding="0" cellspacing="0">
              ...
              <center><h2 style="font-size: 16px; font-weight: 300; color: #227ef0; margin-top: 0px;">Thanks for Contacting Us</h2></center>
            </tr>
            <tr>
                <td align="left" style="color:#292c34; font-size: 13px; padding-bottom:20px;">
                   To,<br> <?php echo $customer->contact_person; ?><br>
                    ...
                    <?php if(trim($customer->city_name)){echo $customer->city_name.',';}?>
                    <?php if(trim($customer->country_name)){echo $customer->country_name;}?>.
                </td>
            </tr>
                            <tr>
                                <td align="left" style="color:#555; line-height: 16px; text-align: justify;">
                                <p style="font-weight: 400; color: #3e3737; font-size: 13px; margin-top: 8px; margin-bottom: 8px;">Thank you for your inquiry mail.<br>However we regret to inform you that the required product/specification/Cost is not in our scope of supply. Looking forward for a successful business relationship with your esteemed organization.</p>
                                </td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <td style="width: 25%; border-left: 0px; padding: 0px 0px 5px 30px;">
                        <h3 style="margin: 0px;  font-weight: 600; font-size: 13px; margin-bottom: 15px;">With Best Regards</h3>
                          <div style="margin-top: 15px;">
                               ...
                               <?php echo $assigned_to_user['name']; ?></h3>
