        ...
        <tr>
            ...
            <td align="center" valign="top" style="background: #ffffff;">
                        ...
                        <tr>
                            <td style="width: 100%; padding: 0px;" align="left" valign="top">
                                ...
                                <span style="font-family: Calibri, Candara, Segoe, sans-serif; color: #585858; font-size: 16px; line-height: 20px;">
                                    <span style="font-size: 20px; letter-spacing: .6px; color: #090909">
                                        <?php if(trim($company['name'])){echo $company['name'].',';}?>
                                    </span><br>
                                    <?php if(trim($company['address'])){echo $company['address'];}?>
                                    <br>      
                                    <?php if(trim($company['city_name'])){echo $company['city_name'].',';}?>
                                    <?php if(trim($company['state_name'])){echo $company['state_name'];}?>
                ...
                <div style="background:#d7d7d775;padding: 1px 0; margin: 0 auto; width: 90%; ">
                    <h3 style="text-transform: uppercase;font-size: 20px;padding: 0;margin: 10px 0;font-family: Calibri, Candara, Segoe, sans-serif; color: #090909; font-weight: 400;">Introduction of Your New Account Manager</h3>
                </div>
                                ...
                                <font face="'Source Sans Pro', sans-serif" color="#585858" style="font-size: 24px; line-height: 32px;">
                                    <span style="font-family:  Calibri, Candara, Segoe, sans-serif; color: #090909; font-size: 16px; line-height: 20px;">
                                       <span style="font-weight: 700;color: #090909;">
                                        ...
                                        <?php if(trim($customer->city) && trim($customer->country)){echo ',';}?>
                    ...
                    <tr>
                        <td align="left" valign="top">     
                            ...
                            <font face="Arial, Helvetica, sans-serif;" color="#585858"
                                style="font-size: 24px; line-height: 32px;">
                                <span
                                    style="font-family: Arial, Helvetica, sans-serif; color: #090909; font-size: 13px; line-height: 15px;">Let us take the opportunity to introduce you with <b><?php echo ($assigned_to_user['gender']=='M')?'Mr.':'Ms.'; ?><?php echo $assigned_to_user['name']; ?></b> as your new account manager.<!--  for your enquiry dated <?php //echo date_db_format_to_display_format($lead_info->create_date); ?> (RFQ No <?php echo $lead_info->id; ?>) --> <br>For any query, please feel free to contact:</span>
                            </font>
               ...
               <div style="height: 3px;background:#99c1e5; width: 90%;margin:0px auto 10px auto;  "></div>
                                        ...
                                        <td class="mob_center" align="left" valign="top">
                                            ...
                                            <font face="Arial, Helvetica, sans-serif;" color="#000000"
                                                style="font-size: 20px; line-height: 23px; ">
                                                    <span
                                                    style="font-family: Arial, Helvetica, sans-serif; color: #090909; font-size: 13px; line-height: 20px;"><?php echo ($assigned_to_user['gender']=='M')?'Mr.':'Ms.'; ?><?php echo $assigned_to_user['name']; ?></span><br>
                                            </font>
                                            ...
                                            <font face="Arial, Helvetica, sans-serif;" color="#090909;"
                                                style="font-size: 13px; line-height: 20px;">                                                
                                                    <span
                                                    style="font-family: Arial, Helvetica, sans-serif; color: #090909; font-size: 13px; line-height: 23px; font-weight: 400;"><?php echo $assigned_to_user['mobile']; ?></span>
                                                    <br>
                                                    <span
                                                    style="font-family: Arial, Helvetica, sans-serif; color: #090909; font-size: 13px; line-height: 20px;">Email: <?php echo $assigned_to_user['email']; ?></span> <br>
                                            </font>
                                        </td>
                                        <td width="18"
                ...
                <div class="mob_div"  style="display: inline-block; vertical-align: top; width: 100%; min-width: 330px;">
                    <table cellpadding="0" cellspacing="0" border="0" width="100%"
                        style="width: 100% !important; min-width: 100%; max-width: 100%;">
                        <tr>
                            <td class="mob_center" align="left" valign="top">
                                ...
                                <font face="Arial, Helvetica, sans-serif;" color="#000000"
                                    style="font-size: 20px; line-height: 23px; ">
                                        <span
                                        style="font-family: Arial, Helvetica, sans-serif; color: #090909; font-size: 13px; line-height: 20px;">
                                        Team, <?php echo $company['name'];?></span><br>
                                </font>
                                <div style="height: 1px; line-height: 1px; font-size: 1px;">
                                    &nbsp;</div>
                                <font face="Arial, Helvetica, sans-serif;" color="#090909;"
                                    style="font-size: 13px; line-height: 20px;">                                                
                                        <span
                                        style="font-family: Arial, Helvetica, sans-serif; color: #090909; font-size: 13px; line-height: 23px; font-weight: 400;">Mobile: <?php echo $company['mobile1'];?></span>
                                        <br>
                                        <span
                                        style="font-family: Arial, Helvetica, sans-serif; color: #090909; font-size: 13px; line-height: 20px;">Email: <?php echo $company['email1']; ?></span> <br>
                                        <span
                                        style="font-family: Arial, Helvetica, sans-serif; color: #090909; font-size: 13px; line-height: 20px;">Website: <?php echo $company['website']; ?></span> <br>
                                </font>
                            </td>
                            <td width="18"
                                style="width: 18px; max-width: 18px; min-width: 18px;">&nbsp;
                ...
                <tr>
                     ...
                     <?php /* ?><p style="margin: 4px 0; line-height: 14px; font-size: 9px; color: #888; ">Powered By: <a href="https://lmsbaba.com/" target="_blank" style="color: #888;">LMSbaba.com</a></p>
						...
						<div style="float: right;text-align: center;">
                            <span style="font-size: 12px;color: #999;font-family: Calibri, Candara, Segoe, sans-serif;">
								Powered by
							</span>
