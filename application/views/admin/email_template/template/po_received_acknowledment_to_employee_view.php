    ...
    <tr>
        <td data-bgcolor="bg-module" bgcolor="#fff">
            <table width="600" align="center" style=" background: #ccc; padding: 0px 20px 0px; margin:0 auto;" cellpadding="0" cellspacing="0">
              ...
              <center><h2 style="font-size: 16px; font-weight: 300; color: #227ef0; margin-top: 0px;">Hurray!! <?php echo ($assigned_to_user['gender']=='M')?'Mr.':'Ms.'; ?> <?php echo $assigned_to_user['name']; ?> has received a PO</h2></center>
             </tr>
            <tr>
                <td align="left" style="color:#555; line-height: 16px; text-align: justify;">
                    <p style="font-weight: 400; color: #3e3737; font-size: 13px; margin-top: 8px; margin-bottom: 8px;">Congratulations Team! <?php echo ($assigned_to_user['gender']=='M')?'Mr.':'Ms.'; ?> <?php echo $assigned_to_user['name']; ?> has received a Purchase Order!

                    </p>
                    <p>
                    Buyer's Name: <?php echo $customer['contact_person']; ?><br>
                    Company Name: <?php echo $customer['company_name']; ?><br>
                    Address: <?php echo $customer['address']; ?>, <?php echo $customer['city']; ?>, <?php echo $customer['country']; ?><br>
                    Mobile: <?php echo $customer['mobile']; ?><br>
                    Email: <?php echo $customer['email']; ?>
                    </p>
                    <p>
                        PO ID: <?php echo $po_number; ?><br>
                        PO Date: <?php date_db_format_to_display_format($po_date); ?>
