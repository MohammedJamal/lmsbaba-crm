                    ...
                    <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                            <td data-color="text" data-size="size navigation" data-min="10" data-max="22" data-link-style="text-decoration:none; color:#888;" class="nav" align="right" style="">
                               <div><img src="<?php echo assets_url(); ?>uploads/clients/<?php echo $client_id; ?>/company/logo/<?php echo $company['logo']; ?>" style=" width: 80px;"></div>
                            </td>
                        </tr>
                    </table>
                </th>
                ...
                <tr>
                    <td style="padding:10px 30px 5px;" bgcolor="#fff">
                        <table width="100%" cellpadding="0" cellspacing="0">
                          ...
                          <center><h2 style="font-size: 16px; font-weight: 300; color: #227ef0; margin-top: 0px;"><?php echo $email_subject; ?></h2></center>
                         </tr>

                         <tr>
                            <td align="left" style="color:#292c34; font-size: 13px; padding-bottom:20px;">
                               To,<br> <?php echo $email_to; ?><br>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td align="left" style="color:#555; line-height: 16px; text-align: justify;">
                                <p style="font-weight: 400; color: #3e3737; font-size: 13px; margin-top: 8px; margin-bottom: 8px;"><?php echo $email_body; ?></p>
                            </td>
                        </tr>
                        </table>
                    </td>
             ...
             <tr>
                       ...
                       <td align="" style=" width: 100%; text-align: center;border-left: 0px;">
                            <div>
                               ...
                               <p style="margin: 4px 0; line-height: 14px; font-size: 9px; color: #888; "><?php rander_company_address('email_template',$client_info); ?></p>
                            </div>
                        </td>
                    </tr>
            </table> 
