                            ...
                            <td style="padding:0px 15px; background: #fff">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="font-size: 13px;"><?php if($lead_info->current_stage=='PENDING'){echo 'IN PROCESS';}else if($lead_info->current_stage=='DEAL LOST' || $lead_info->current_stage=='AUTO DEAL LOST' || $lead_info->current_stage=='AUTO-REGRETTED'){echo 'REGRETTED';}else{echo $lead_info->current_stage;} ?></td>
    ...
    <tr>
        <td data-bgcolor="bg-module" bgcolor="#fff">
            <table width="600" align="center" style=" background: #ccc; padding: 0px 20px 0px; margin:0 auto;" cellpadding="0" cellspacing="0">
              ...
              <center><h2 style="font-size: 16px; font-weight: 300; color: #227ef0; margin-top: 0px;">Message from your account manager</h2></center>
            </tr>
            <tr>
                <td align="left" style="color:#292c34; font-size: 13px; padding-bottom:20px;">
                   ...
                   <?php 
                        ...
                        if(trim($customer->city_name)){
                            echo $customer->city_name.', ';
                        } 
                        if(trim($customer->country_name)){
                    ...
                    ?>.
                            ...
                            <tr>
                                ...
                                <p style="font-weight: 400; color: #3e3737; font-size: 13px; margin-top: 8px; margin-bottom: 8px;"><?php echo $updated_comments; ?></p>
                                </td>
                            </tr>
                            <?php /* ?>
                            <tr>
                                <td style="color:#555; line-height: 23px; font-size: 13px;">
                                    <p style=" margin-top: 0px; font-weight: 400; color: #3e3737; font-size: 13px;">Please feel free to contact.</p>
                                </td>
        ...
        <td data-bgcolor="bg-module" bgcolor="#fff">
            <table width="600" align="center" style=" background: #ccc; padding: 0px 20px 0px; margin:0 auto;" cellpadding="0" cellspacing="0">
                <tr style="background: #fff; padding:5px 30px 5px;">
                    ...
                    <?php */ ?>
                    <td align="" style=" width: 70%;  border-left: 0px; padding: 0px 0px 5px 30px;">
