    ...
    <tr>
        <td data-bgcolor="bg-module" bgcolor="#fff">
            <table width="600" align="center" style=" background: #ccc; padding: 0px 20px 0px; margin:0 auto;" cellpadding="0" cellspacing="0">
              ...
              <center><h2 style="font-size: 16px; font-weight: 300; color: #227ef0; margin-top: 0px;">Introduction of new account manager</h2></center>
            </tr>
            <tr>
                    ...
                    ?>.
                            ...
                            <tr>
                                <td align="left" style="color:#555; line-height: 16px; text-align: justify;">
                                    ...
                                    Dear Sir/Madam,<br>
                                    Let us take the opportunity to introduce you with <?php echo $assigned_to_user['name']; ?> as your new relationship manager for your enquiry. <?php echo $assigned_to_user['name']; ?> will be following your for your purchase requirements.
