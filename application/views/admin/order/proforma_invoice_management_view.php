  ...
  <div class="content-view"> 
    ...
    <div class="card process-sec">
      <div class="filter_holder new">
        <div class="pull-left">
          <h5 class="lead_board"> Proforma Invoice Management </h5>
                ...
                <table class="table custom-table" id="renewal_table">
                  <thead>
                    <tr>
                      <tr>
                        <th>Order ID</th>
                        <th scope="col" class="sort_order" data-field="t1.pro_forma_no" data-orderby="asc">Proforma No.</th>
                        <th>Proforma Date</th>
                        <th>Company</th>
                        <th>Amount</th>
                        <th>Payment Terms</th>
...
<script src="<?php echo assets_url();?>js/custom/order/proforma_invoice_management.js?v=<?php echo rand(0,1000); ?>"></script>
