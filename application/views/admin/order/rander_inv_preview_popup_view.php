        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="justify-content-between">
                    ...
                    <li><a href="JavaScript:void(0);" class="open_po_popup_steps btn btn-primary txt-upper pro-form-preview-bt" data-step="4" data-lowp="<?php echo $lowp; ?>" data-lo_id="<?php echo $po_register_info->lead_opportunity_id; ?>" data-lid="<?php echo $po_register_info->lead_id; ?>"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</a></li>
                    <?php } ?>
                    <?php if($po_register_info->invoice_type=='S'){ ?>
                    <li><a href="<?php echo base_url($this->session->userdata['admin_session_data']['lms_url'].'/order/preview_invoice/'.$po_inv_info->lead_opportunity_wise_po_id);?>" class="btn btn-primary txt-upper pro-form-preview-bt <?php echo($po_inv_info->invoice_no)?'':'inv_no_missing'; ?>" target="_blank" ><i class="fa fa fa-eye" aria-hidden="true"></i> Preview</a></li>
                    <?php } ?>
                    <?php if($po_register_info->is_cancel=='N'){ ?>             
                    <li><a href="JavaScript:void(0);" class="btn btn-primary txt-upper pro-form-preview-bt <?php echo($po_inv_info->invoice_no)?'send_inv_to_buyer_modal':'inv_no_missing'; ?>" data-lowp="<?php echo $po_inv_info->lead_opportunity_wise_po_id; ?>" ><i class="fa fa-paper-plane" aria-hidden="true"></i> Send</a></li>
                    <?php } ?>
                    ...
                    ?>
                    <li><a href="<?php echo $download_url;?>" class="btn btn-primary txt-upper pro-form-preview-bt <?php echo($po_inv_info->invoice_no)?'':'inv_no_missing'; ?>" target="_blank" ><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Download</a></li>
                </ul>
            </div>
        </div>
    </div>
