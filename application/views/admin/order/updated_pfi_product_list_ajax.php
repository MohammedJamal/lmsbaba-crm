    ...
    <tr>
      ...
      <th class="text-center">Unit Price <br>
        ...
        <th class="text-center">Discount<br>
          <select id="is_discount_p_or_a_pfi" class="form-control color-select small-select width-60" name="is_discount_p_or_a_pfi"> 
      ...
      <tr id="tr_<?php echo $output->id;?>">
          ...
          <td>
            <div class="padding0 d-flex">
              <input type="text" class="width-80 default-input calculate_pfi_price_update double_digit" id="" name="" value="<?php echo $output->price;?>" data-field="price" data-id="<?php echo $output->id;?>" data-pid="<?php echo $output->product_id; ?>" data-pfi_id="<?php echo $output->po_pro_forma_invoice_id; ?>" />
          ...
          <td>
             <input type="text" class="width-60 default-input calculate_pfi_price_update double_digit" id="" name="" value="<?php echo $output->discount; ?>" data-field="discount" data-id="<?php echo $output->id;?>" data-pid="<?php echo $output->product_id; ?>" data-pfi_id="<?php echo $output->po_pro_forma_invoice_id; ?>"   />  
          </td>
          <td>
              <input type="text" class="width-60 default-input calculate_pfi_price_update double_digit" id="" name="" value="<?=ceil($output->gst);?>" data-field="gst" data-id="<?php echo $output->id; ?>" data-pid="<?php echo $output->product_id; ?>" data-pfi_id="<?php echo $output->po_pro_forma_invoice_id; ?>"  />
          </td>
          <td>             
    ...
    <?php 
      ...
      <tr id="tr_additional_charge_<?php echo $charge->id;?>" class="<?php echo ($j%2==0)?'event':'odd'; ?>">
        <td style="width: 249px;">
          ...
          <?php //echo $charge->additional_charge_name; ?></td>
