								...
								<tr>
									<td style="width: 100%; height: auto; display: inline-block;padding: 15px 0; border-bottom: #000000 1px dashed;">
										...
										<div style="font-size:12px; color:#000;margin: 0 0 10px 0;  width: 100%; display:inline-block;font-family: century-gothic;">	<?php 
											echo ($po_pro_forma_inv_info->bill_from)?$po_pro_forma_inv_info->bill_from:'N/A';
											?>
										</div>
									</td>
								</tr>
							...
							<tbody>
								<tr>
									<td style="width: 100%; height: auto; display: inline-block;padding: 15px 0;">
										...
										<div style="font-size:12px; color:#000;margin: 0 0 10px 0;  width: 100%; display:inline-block;font-family: century-gothic;">	<?php 
											echo ($po_pro_forma_inv_info->bill_to)?$po_pro_forma_inv_info->bill_to:'N/A';
											?>
										</div>
									</td>
								</tr>
							...
							<tbody>
								<tr>
									<td style="width: 100%; height: auto; display: inline-block;padding: 8px 10px; border-bottom: #000000 1px solid;box-sizing: border-box;">
										<div style="font-size:10px; color:#000;margin: 0; font-weight:700; width: 100%; display:inline-block;font-family: century-gothic;"><b>Proforma No:  <?php 
											echo ($po_pro_forma_inv_info->pro_forma_no)?$po_pro_forma_inv_info->pro_forma_no:'N/A';
											?></b></div>
									</td>
								</tr>
								<tr>
									<td style="width: 100%; height: auto; display: inline-block;padding: 8px 10px; border-bottom: #000000 1px solid;box-sizing: border-box;">
										<div style="font-size:10px; color:#000;margin: 0; font-weight:700; width: 100%; display:inline-block;font-family: century-gothic;"><b>Proforma Date: <?php 
											echo ($po_pro_forma_inv_info->pro_forma_date)?date_db_format_to_display_format($po_pro_forma_inv_info->pro_forma_date):'N/A';
											?></b></div>
									</td>
								</tr>
								<tr>
									<td style="width: 100%; height: auto; display: inline-block;padding: 8px 10px; border-bottom: #000000 1px solid;box-sizing: border-box;">
										<div style="font-size:10px; color:#000;margin: 0; font-weight:700; width: 100%; display:inline-block;font-family: century-gothic;"><b>Due Date: <?php 
											echo ($po_pro_forma_inv_info->due_date!='' && $po_pro_forma_inv_info->due_date!='0000-00-00')?date_db_format_to_display_format($po_pro_forma_inv_info->due_date):'N/A';
											?></b></div>
									</td>
								</tr>
								<tr>
									<td style="width: 100%; height: auto; display: inline-block;padding: 8px 10px; border-bottom: #000000 1px solid;box-sizing: border-box;">
										<div style="font-size:10px; color:#000;margin: 0; font-weight:700; width: 100%; display:inline-block;font-family: century-gothic;"><b>Expected Delivery Date: <?php 
											echo ($po_pro_forma_inv_info->expected_delivery_date!='' && $po_pro_forma_inv_info->expected_delivery_date!='0000-00-00')?date_db_format_to_display_format($po_pro_forma_inv_info->expected_delivery_date):'N/A';
											?></b></div>
									</td>
								</tr>
								<tr>
									<td style="width: 100%; height: auto; display: inline-block;padding: 8px 10px;">
										<?php if($po_pro_forma_inv_info->ship_to){ ?>
										<h2 style="font-size:10px; color:#000000;margin: 0 0 5px 0; font-weight: 700;font-family: century-gothic;"><b>SHIP TO:</b></h2>
										<div style="font-size:12px; color:#000;margin: 0 0 10px 0;  width: 100%; display:inline-block;font-family: century-gothic;">	<?php 
											echo ($po_pro_forma_inv_info->ship_to)?$po_pro_forma_inv_info->ship_to:'N/A';
											?>
										</div>
										<?php }else{echo'&nbsp;';} ?>
									</td>
			...
			<thead>
				<tr>
					...
					<th style="box-sizing: border-box; padding: 10px; border-right: #969696 1px solid; vertical-align: top; background: #d6d6d6; border-left:#888888 1px solid; border-bottom:#888888 1px solid; font-weight:400">
						...
						<span style="font-size:10px; color:#000;margin: 0; font-weight:100; width: 100%;font-family: century-gothic; white-space: nowrap;">(<?php echo $po_pro_forma_inv_info->currency_type; ?>)</span>
					</th>
					<th style="box-sizing: border-box; padding: 10px; border-right: #969696 1px solid; vertical-align: top; background: #d6d6d6; border-left:#888888 1px solid; border-bottom:#888888 1px solid;">
					...
					<th style="box-sizing: border-box; padding: 10px; border-right: #969696 1px solid; vertical-align: top; background: #d6d6d6; border-bottom:#888888 1px solid; font-weight:400">
						...
						<span style="font-size:10px; color:#000;margin: 0; font-weight:400; width: 100%;font-family: century-gothic;">(<?php echo $po_pro_forma_inv_info->currency_type; ?>)</span>
					</th>
				</tr>
			</thead>
			<tbody>
...
<?php if($po_pro_forma_inv_info->terms_conditions){ ?>
				...
				<tr>
			      	<td style="box-sizing: border-box; padding: 15px; vertical-align: middle; background: #FFF;">
			      		<span style="font-size:10px; color:#000;margin: 0; font-weight:400; width: 100%; display:inline-block; text-align: left; line-height: 20px;font-family: century-gothic;">
			      			<?php 
									echo $po_pro_forma_inv_info->terms_conditions;
									?></span>
			      	</td>
			    </tr>
			</tbody>
...
<?php } ?>
<?php if($po_pro_forma_inv_info->additional_note){ ?>
	<div class="head-invoice" style="width:100%; height:auto; display: inline-block; margin: 0 0 15px 0;">
		<table style="width:100%; border-collapse: collapse; border:#888888 1px solid;">
			<thead>
				<tr>
				...
				<tr>
			      <td style="box-sizing: border-box; padding: 15px; vertical-align: middle; background: #FFF;">
			      		<span style="font-size:10px; color:#000;margin: 0; font-weight:400; width: 100%; display:inline-block; text-align: left; line-height: 20px;font-family: century-gothic;"><?php 
									echo $po_pro_forma_inv_info->additional_note;
								?></span>
			      	</td>
			    </tr>
			</tbody>
...
<?php } ?>
<?php 
if($po_pro_forma_inv_info->bank_detail_1!="" || $po_pro_forma_inv_info->bank_detail_2!="")
{ 
	...
	<div class="head-invoice" style="width:100%; height:auto; display: inline-block; margin: 0 0 15px 0;">
		<table style="width:100%; border-collapse: collapse; border:#888888 1px solid;">
			...
			<tbody>
				<tr>
					<?php
					if($po_pro_forma_inv_info->bank_detail_1!="")
					{
					?> 
			      	<td style="box-sizing: border-box; padding: 15px; vertical-align: middle; background: #FFF; border-right:#888888 1px solid;">
			      		<span style="font-size:10px; color:#000;margin: 0; font-weight:400; width: 100%; display:inline-block; text-align: left; line-height: 20px;font-family: century-gothic;">
			      			<?php 
									echo ($po_pro_forma_inv_info->bank_detail_1)?$po_pro_forma_inv_info->bank_detail_1:'N/A';
									?>
								</span>
			      	</td>
			      	<?php
			      	}			      	
							if($po_pro_forma_inv_info->bank_detail_2!="")
							{
			      	?>
			      	<td style="box-sizing: border-box; padding: 15px; vertical-align: middle; background: #FFF;">
			      		<span style="font-size:10px; color:#000;margin: 0; font-weight:400; width: 100%; display:inline-block; text-align: left; line-height: 20px;font-family: century-gothic;">
			      			<?php 
									echo ($po_pro_forma_inv_info->bank_detail_2)?$po_pro_forma_inv_info->bank_detail_2:'N/A';
									?>
			      		</span>
			      	</td>
			      	<?php
...
<?php } ?>
	...
	<div class="head-invoice" style="width:100%; height:auto; display: inline-block; margin: 0 0 15px 0;">
		<div  style="width:250px; height:auto; display: inline-block; margin: 0; text-align:center;">
			...
			<?php
			if($po_pro_forma_inv_info->is_digital_signature_checked=='Y' && $company['digital_signature']!='')
			{
			...
			<div  style="width:100%; height:auto; display: inline-block; margin: 0; white-space:nowrap; font-size: 14px;color: #000;font-family: century-gothic;">
				<?php echo ($po_pro_forma_inv_info->name_of_authorised_signature)?$po_pro_forma_inv_info->name_of_authorised_signature:''; ?>
			</div>
			<?php
			}
			else
			...
			<div  style="width:100%; height:auto; display: inline-block; margin: 0; white-space:nowrap; font-size: 14px;color: #000;font-family: century-gothic;">
				<?php echo ($po_pro_forma_inv_info->thanks_and_regards)?$po_pro_forma_inv_info->thanks_and_regards:''; ?>
			</div>
				<?php
			}
			?>
