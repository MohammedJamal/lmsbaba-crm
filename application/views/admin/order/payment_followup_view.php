  ...
  <div class="content-view"> 
    ...
    <div class="card process-sec">
      <div class="filter_holder new">
        <div class="pull-left">
          <h5 class="lead_board"> Payment Followup </h5>
        ...
        <div class="filter_right filter_sort">
          <div class="filter_block">
            ...
            <div class="filter_item">
              <input type="text" class="sort_dd" name="filter_string_search" id="filter_string_search" />              
            </div>
          </div>
          <div id="btnContainer">
              ...
              <div class="table-one-holder">
                <table class="table custom-table" id="renewal_table">
                  <thead>
                    <tr>
                      <tr>
                        <th scope="col" class="sort_order" data-field="t1.lead_opportunity_wise_po_id" data-orderby="asc">Order ID</th>
                        <th>Company</th>
                        <th scope="col" class="sort_order" data-field="t2.payment_date" data-orderby="asc">Payment Due Date</th> 
                        <th>Amount Due</th>
      ...
      <div class="card-block">  
         <?php /* ?>
            ...
            <div class="row">
                <div class="col-md-12">
                  <a class="new_filter_btn" href="JavaScript:void(0);" id="download_payment_followup_csv">
...
<script src="<?php echo assets_url();?>js/custom/order/payment_followup.js"></script>
<script src="<?php echo assets_url();?>js/custom/order/order.js"></script>
