        ...
        <div class="repply-body">
            <div class="buyer-scroller">
                <div class="buying-requirements" style="min-height: 250px;"> 
                    ...
                    We are yet to receive payment for proforma invoice number <?php echo ($po_register_info->pro_forma_no)?$po_register_info->pro_forma_no:''; ?> which is attached with this email. Please let us know we can expect to receive payment, and don't hesitate to reach out if you have any questions or concerns.<br><br>We assure you that our best attention will be given to your order.
                    <br><br>
                    Thanking you.<br>
                    Yours Faithfully,<br>
                    <?php 
            ...
            <ul style="">                        
              <li style="position: relative;">
                  <div class="btn-group-n dropup">
                    <button type="button" class="btn custom_blu" id="send_pfi_to_buyer_confirm">Send Proforma Invoice</button>
                  </div>
              </li> 
              ...
              <li style="" class="">
                  <div class="pull-left ff">
                    ...
                    { 
                        ...
                        $f_name="PROFORMA INVOICE ".$po_pro_forma_inv_info->pro_forma_no."-".date_format(date_create(date('Y-m-d')),'M y')."-".strtoupper($company_name_tmp);
                    ...
                    ?>
                    <a href="<?php echo $download_url;?>" target="_blank" > <i class="fa fa-paperclip" aria-hidden="true"></i> <span>View Proforma Invoice</span></a>
                  </div>
              </li>
            </ul>
        </div>                    
