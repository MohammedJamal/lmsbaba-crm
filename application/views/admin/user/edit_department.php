...
<form class="tsf-content" action="<?php echo base_url()?><?php echo $this->session->userdata['admin_session_data']['lms_url']; ?>/user/edit_department/<?php echo $row->id?>" method="post" name="validate" id="validate">
