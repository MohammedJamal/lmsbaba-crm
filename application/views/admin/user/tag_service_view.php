            ...
            <div class="row m-b-1">
              <div class="col-sm-3 pr-0">
                  <div class="bg_white back_line">
                    <h4><a href="<?php echo base_url() ?><?php echo $this->session->userdata['admin_session_data']['lms_url']; ?>/user/manage_employee">Tag Services</a> </h4>
                  </div>
              </div>
                  ...
                  <!-- <pre><?php print_r($service_info['all_available_service']); ?></pre> -->
                    <!-- <pre>
                      ...
                      <div class="no-more-tables"> 
                          <div class="row">
                            <div class="col-sm-3">
                              <label class="col-form-label"><b>Select a Service:</b></label>
