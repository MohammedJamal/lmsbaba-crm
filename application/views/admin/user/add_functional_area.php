    ...
    <div class="main-content">
      <div class="content-view">
        <div class="layout-md b-b card process-sec">
          <div class="layout-column-md card-block">
            <div class="wizards">                 
              <!-- BEGIN STEP FORM WIZARD -->
              <div class="tsf-wizard tsf-wizard-1"> 
                <!-- BEGIN STEP CONTAINER -->
                <div class="tsf-container">
<form class="tsf-content" action="<?php echo base_url()?><?php echo $this->session->userdata['admin_session_data']['lms_url']; ?>/user/add_functional_area" method="post" name="validate" id="validate">
        <div id="error"></div>
  <div class="">
    <fieldset>
       <h5 class="lead_board">Add Functional Area</h5>
        <div class="row">
...
<div class="tsf-controls ">  
    <button class="btn btn-right btn-primary btn-round-shadow pull-right"  onclick="form_submit()">SUBMIT</button>
</div>
<!-- END CONTROLS-->
</div>
<!-- END STEP CONTAINER -->
