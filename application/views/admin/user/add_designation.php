...
<div class="main-panel">
  <div class="min_height_dashboard"></div> 
    ...
    <div class="main-content">
      ...
      <form class="tsf-content" action="<?php echo base_url()?><?php echo $this->session->userdata['admin_session_data']['lms_url']; ?>/user/add_designation" method="post" name="validate" id="validate">
          <div id="error"></div>
            <div class="">
                  <fieldset>
                      <h5 class="lead_board">Add Designation</h5>
                      <div class="row">
