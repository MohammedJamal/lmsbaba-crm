...
if($rule_id=='2') // country
{
	...
	<div class="form-group row">
		<div class="col-md-12">
			...
			<select class="form-control custom-select" name="aajjo_assign_to_<?php echo $rule_id; ?>_<?php echo $cnt; ?>[]" id="aajjo_assign_to_<?php echo $rule_id; ?>_<?php echo $cnt; ?>" multiple="multiple" >
...
else if($rule_id=='3')
{
	...
	?>
	<div class="aj_inner_div_loop card" id="aj_inner_div_<?php echo $rule_id; ?>_<?php echo $cnt; ?>">
	<div class="del_div_bt"><a href="JavaScript:void(0);" class="aj_del_div" data-cnt="<?php echo $cnt; ?>" data-ruleid="<?php echo $rule_id; ?>">X</a></div>
	<div class="form-group row">
		<div class="col-md-12">
			<label for="" class="col-form-label">Select Indian State<span class="text-danger">*</span> :</label>
			<select class="form-control custom-select-auto" name="aj_state_<?php echo $rule_id; ?>_<?php echo $cnt; ?>[]" id="aj_state_<?php echo $rule_id; ?>_<?php echo $cnt; ?>" multiple="multiple" >
		...
		<div class="col-md-12">
			...
			<ul class="employee_assign">
				...
				<li>
					...
					<input type="checkbox" name="aajjo_assign_to_<?php echo $rule_id; ?>_<?php echo $cnt; ?>[]" id="" value="<?php echo $user->id; ?>" class="aajjo_assign_to_<?php echo $rule_id; ?>_<?php echo $cnt; ?>" <?php if(in_array($user->id, $existing_assign_to_arr)){echo'checked';} ?>>
