...
if($rule_id=='2')
{
	...
	?>
	<div class="fb_inner_div_loop card" id="fb_inner_div_<?php echo $rule_id; ?>_<?php echo $cnt; ?>">
	<div class="del_div_bt"><a href="JavaScript:void(0);" class="fb_del_div" data-cnt="<?php echo $cnt; ?>" data-ruleid="<?php echo $rule_id; ?>">X</a></div>
	...
	<div class="form-group row">
		<div class="col-md-12">
			...
			<select class=" form-control custom-select" name="facebook_assign_to_<?php echo $rule_id; ?>_<?php echo $cnt; ?>[]" id="facebook_assign_to_<?php echo $rule_id; ?>_<?php echo $cnt; ?>" multiple="multiple" >
...
else if($rule_id=='3')
{
	...
	<div class="form-group row">
		<div class="col-md-12">
			...
			<select class="form-control custom-select-auto" name="fb_state_<?php echo $rule_id; ?>_<?php echo $cnt; ?>[]" id="fb_state_<?php echo $rule_id; ?>_<?php echo $cnt; ?>" multiple="multiple" >
