...
if($rule_id=='2') // country
{
	...
	<div class="form-group row">
		<div class="col-md-12">
			...
			<select class="form-control custom-select" name="tradeindia_assign_to_<?php echo $rule_id; ?>_<?php echo $cnt; ?>[]" id="tradeindia_assign_to_<?php echo $rule_id; ?>_<?php echo $cnt; ?>" multiple="multiple" >
...
else if($rule_id=='3')
{
	...
	?>
	<div class="ti_inner_div_loop card" id="ti_inner_div_<?php echo $rule_id; ?>_<?php echo $cnt; ?>">
	<div class="del_div_bt"><a href="JavaScript:void(0);" class="ti_del_div" data-cnt="<?php echo $cnt; ?>" data-ruleid="<?php echo $rule_id; ?>">X</a></div>
	<div class="form-group row">
		<div class="col-md-12">
			<label for="" class="col-form-label">Select Indian State<span class="text-danger">*</span> :</label>
			<select class="form-control custom-select-auto" name="ti_state_<?php echo $rule_id; ?>_<?php echo $cnt; ?>[]" id="ti_state_<?php echo $rule_id; ?>_<?php echo $cnt; ?>" multiple="multiple" >
