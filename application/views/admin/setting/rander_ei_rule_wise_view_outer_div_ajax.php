...
if($rule_id=='2') // country
{
	...
	?>
	<div class="inner_div_loop card" id="inner_div_<?php echo $rule_id; ?>_<?php echo $cnt; ?>">
	<div class="del_div_bt"><a href="JavaScript:void(0);" class="del_div" data-cnt="<?php echo $cnt; ?>" data-ruleid="<?php echo $rule_id; ?>">X</a></div>
	...
	<div class="form-group row">
		<div class="col-md-12">
			...
			<select class="form-control custom-select" name="exporterindia_assign_to_<?php echo $rule_id; ?>_<?php echo $cnt; ?>[]" id="exporterindia_assign_to_<?php echo $rule_id; ?>_<?php echo $cnt; ?>" multiple="multiple" >
...
else if($rule_id=='3')
{
	...
	?>
	<div class="ei_inner_div_loop card" id="ei_inner_div_<?php echo $rule_id; ?>_<?php echo $cnt; ?>">
	<div class="del_div_bt"><a href="JavaScript:void(0);" class="ei_inner_div" data-cnt="<?php echo $cnt; ?>" data-ruleid="<?php echo $rule_id; ?>">X</a></div>
	<div class="form-group row">
		<div class="col-md-12">
			<label for="" class="col-form-label">Select Indian State<span class="text-danger">*</span> :</label>
			<select class="form-control custom-select-auto" name="ei_state_<?php echo $rule_id; ?>_<?php echo $cnt; ?>[]" id="ei_state_<?php echo $rule_id; ?>_<?php echo $cnt; ?>" multiple="multiple" >
		...
		<div class="col-md-12">
			...
			<ul class="employee_assign">
				...
				<li>
					...
					<input type="checkbox" name="exporterindia_assign_to_<?php echo $rule_id; ?>_<?php echo $cnt; ?>[]" id="" value="<?php echo $user->id; ?>" class="exporterindia_assign_to_<?php echo $rule_id; ?>_<?php echo $cnt; ?>" <?php if(in_array($user->id, $existing_assign_to_arr)){echo'checked';} ?>>
