                  ...
                  <div class="card-body p-0">
                    <div class="tab_gorup side-by-side-- custom-style-tab">
                      ...
                      <!-- <div class="tab tab-group-sec">   
                        <div class="setting-title">Target Settings</div>
                        <button class="tablinks" onClick="openCity(event, 'kpi_settings')" id="defaultOpen" type="button">
                                    ...
                                    <div class="col-sm-12">
                                      <h3 class="text-info">
                                          <div class="row">
                                            ...
                                            Set Monthly Performance Scorecard 
                                            </div>
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-2 text-right"> <a href="<?php echo base_url() ?><?php echo $this->session->userdata['admin_session_data']['lms_url']; ?>/setting/target" id="" class="small-txt"><i class="fa fa-plus" aria-hidden="true"></i> Set KPIs </a></div>
                                          </div>                                        
                                      </h3>
                                    </div>
                                 </div>  
                                      ...
                                      <div class="form-group row">
                                          ...
                                          <?php /* ?>
                                          <div class="col-md-6">
                                            <lable><b>Report for </b></lable>
                                              <select class="form-control" name="set_report_for" id="set_report_for">
                                          ...
                                          <div class="col-md-6">
                                            <lable><b>KPI By</b></lable>
                                              <select class="form-control" name="set_kpi_target_by" id="set_kpi_target_by">
                                                <option value="">Select</option>  
                                                <?php foreach($kpi_target_by as $by){ ?>
                                                  <option value="<?php echo $by['kpi_target_by']; ?>">
                                                    <?php 
                                                    if($by['kpi_target_by']=='F'){echo'By Functional Area';}
                                                    else if($by['kpi_target_by']=='D'){echo'By Department';}
                                                    else if($by['kpi_target_by']=='U'){echo'By User';} 
                                                    ?>
                                                  </option>  
                                                <?php } ?>
                                              </select>
                                          ...
                                          <?php */ ?>
                                          <div class="col-md-12"  id="randet_kpi_target_by_wise_user_div"></div>
                                          <div class="col-md-12"  id="rander_user_wise_kpi_set_div"></div> 
