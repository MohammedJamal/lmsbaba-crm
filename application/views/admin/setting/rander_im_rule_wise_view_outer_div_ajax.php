...
if($rule_id=='2') // country
{
	...
	<div class="form-group row">
		<div class="col-md-12">
			...
			<select class="form-control custom-select" name="indiamart_assign_to_<?php echo $rule_id; ?>_<?php echo $cnt; ?>[]" id="indiamart_assign_to_<?php echo $rule_id; ?>_<?php echo $cnt; ?>" multiple="multiple" >
...
else if($rule_id=='3') // state
{
	...
	<div class="form-group row">
		<div class="col-md-12">
			...
			<select class="form-control custom-select-auto" name="state_<?php echo $rule_id; ?>_<?php echo $cnt; ?>[]" id="state_<?php echo $rule_id; ?>_<?php echo $cnt; ?>" multiple="multiple" >
		...
		<div class="col-md-12">
			...
			<ul class="employee_assign">
				...
				<li>
					...
					<input type="checkbox" name="indiamart_assign_to_<?php echo $rule_id; ?>_<?php echo $cnt; ?>[]" id="" value="<?php echo $user->id; ?>" class="indiamart_assign_to_<?php echo $rule_id; ?>_<?php echo $cnt; ?>" <?php if(in_array($user->id, $existing_assign_to_arr)){echo'checked';} ?>>
