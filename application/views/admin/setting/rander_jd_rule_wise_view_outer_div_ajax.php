...
if($rule_id=='2') // country
{
	...
	?>
	<div class="jd_inner_div_loop card" id="jd_inner_div_<?php echo $rule_id; ?>_<?php echo $cnt; ?>">
	<div class="del_div_bt"><a href="JavaScript:void(0);" class="jd_del_div" data-cnt="<?php echo $cnt; ?>" data-ruleid="<?php echo $rule_id; ?>">X</a></div>
	...
	<div class="form-group row">
		<div class="col-md-12">
			...
			<select class="form-control custom-select" name="justdial_assign_to_<?php echo $rule_id; ?>_<?php echo $cnt; ?>[]" id="justdial_assign_to_<?php echo $rule_id; ?>_<?php echo $cnt; ?>" multiple="multiple" >
...
else if($rule_id=='3')
{
	...
	<div class="form-group row">
		<div class="col-md-12">
			...
			<select class="form-control custom-select-auto" name="jd_state_<?php echo $rule_id; ?>_<?php echo $cnt; ?>[]" id="jd_state_<?php echo $rule_id; ?>_<?php echo $cnt; ?>" multiple="multiple" >
