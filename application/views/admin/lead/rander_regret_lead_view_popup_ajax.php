              ...
              <div class="mail-form-row max-width">
                ...
                <?php } ?>
                 <div class="page-holder float-right mr-45">
                        <ul class="action-ul">                         
                          <li>
                            <a href="JavaScript:void(0)" title="previous" class="back-bt" data-leadid="<?php echo $id; ?>" id="back_to_linked_comment_update_lead_popup"><img src="<?php echo assets_url(); ?>images/left_black.png"> BACK</a>
                          </li>                          
                        </ul>
                     </div>
              </div>
