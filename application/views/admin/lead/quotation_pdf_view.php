...
<body>
  <div class="main-invoice" style="width:800px; height:auto; display: block; margin: 20px auto 0; background:#FFF:">
            ...
            <tr>
               <td width="160px" style="box-sizing: border-box; padding: 10px; border-right: #969696 1px solid; vertical-align: middle;">
                  ...
                  if($logo!='')
                  {
                    ...
                    $tmp_file="assets/uploads/clients/".$client_id."/company/logo/thumb/".$logo;                 
                    if (@!file_exists($tmp_file)) {$profile_img_path = assets_url().'images/user_img_icon.png';}
                  }
                  else
                  {
                        ...
                        <tr>
                           <td style="width: 100%; height: auto; display: inline-block;padding: 8px 10px; border-bottom: #000000 1px solid;box-sizing: border-box;">
                              <div style="font-size:10px; color:#000;margin: 0; font-weight:700; width: 100%; display:inline-block;font-family: century-gothic;">
                                <b>Valid Till: <?php echo date_db_format_to_display_format($quotation['quote_valid_until']); ?></b></div>
                           </td>
                        </tr>
                        <tr>
    ...
    <div style="width:100%; height:auto; display: inline-block; margin: 20px 0; font-weight: 400; font-size:12px; color:#242424">
      <span style="font-size:12px; color:#000000;font-family: century-gothic;"><?php echo $quotation['letter_subject']; ?></span>
    </div>
      ...
      <table style="width:100%; border-collapse: collapse; border:#888888 1px solid;">
         <thead>
            <tr>
               ...
               <th style="box-sizing: border-box; padding: 10px; border-right: #969696 1px solid; vertical-align: top; background: #d6d6d6; border-left:#888888 1px solid; border-bottom:#888888 1px solid; text-align:left;" width="300">
         ...
         <tbody>
          ...
          <tr>
             ...
             <td style="box-sizing: border-box; padding: 10px; border-right: #969696 1px solid; vertical-align: middle; background: #FFF; border-left:#888888 1px solid; border-bottom:#888888 1px solid;text-alignl:left;">
                <div style="font-size:12px; color:#000;margin: 0; width: 100%; display:inline-block;font-family: century-gothic; max-width: 200px;">
