  ...
  <div class="content-view"> 
    ...
    <div class="card process-sec">
      <div class="filter_holder new">
        <div class="pull-left">
          <h5 class="lead_board"> Call Log Leads <a href="JavaScript:void(0)" title="Reload Call Log Leads" id="load_sync_call"><i class="fa fa-refresh" aria-hidden="true"></i></a>
              &nbsp;
          <a href="JavaScript:void(0)" title="Auto Tagged" onclick="update_auto_tagged();"><i class="fa fa-tags text-success" aria-hidden="true"></i></a>
        </h5>
