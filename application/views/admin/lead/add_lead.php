        ...
        <div class="content-view"> 
            <div class="form_bg">            
              <div class="middle_form">
                ...
                <form id="form" name="form" method="post" action="<?php echo base_url()?><?php echo $this->session->userdata['admin_session_data']['lms_url']; ?>/lead/add/">
	                <div class="padding_35">
	                    ...
	                    <div class="form-group row">
	      			    ...
	      			    <div class="form-group row">
	      			      	...
	      			      	<div class="col-sm-8"><input type="text" class="form-control only_natural_number" name="mobile" id="mobile" placeholder="Mobile" value="<?php echo $mobile; ?>" /></div>
            ...
            <div class="form_bg">            
              <div class="middle_form">
                ...
                <form id="frmLeadAdd" name="frmLeadAdd" method="post" action="" class="new-lead-sec-from">
			    	...
			    	<div style="clear: both;"></div>
		    		<div class="padding_35">
	                	<h5 class="lead_board p-0 mb-35">Add a New Lead</h5>
	                	<div class="form-group">
	                		<div class="new-lead-sec">
	                        <h4 class="heading-text-hd">
	                			LEAD DETAILS
                                </h4>
	                		</div>
	                	</div>
	                    <div class="form-group">
							<label>Lead Title<span class="text-danger">*</span>:</label>
								...
								<input type="text" class="form-control" name="lead_title" id="lead_title" placeholder="Lead Title" value=""/>
	                    ...
	                    <div class="form-group">
							<label>Describe Requirements<span class="text-danger">*</span>:</label>
								...
								<textarea rows="5" cols="5" class="form-control basic-wysiwyg-editor" name="lead_requirement" id="lead_requirement" placeholder="Describe Requirements"></textarea>
...
<script src="<?php echo base_url();?>assets/js/custom/lead/add.js"></script>
