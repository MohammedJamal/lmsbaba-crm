<div class="form-group">
	...
	{
		?>
		<span class="tag_row" style="color: red;">Following match found with this email id</span>
		<?php
	}
	?>
	...
	<div class="form-group row tag_row2">
					<label class="col-sm-2 col-form-label">
					&nbsp;
					</label>
					<div class="col-sm-8"> 
					<div class="checkbox checkbox-primary">
                        <input class="styled n" type="checkbox" id="new" name="option1" onclick="setnewcus()" value="1"/>
                        <label for="checkbox2">
                            Add a New Buyer
                        </label>
                    </div>
