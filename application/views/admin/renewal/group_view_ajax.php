...
<tr scope="row">	
	...
	<td class="">		
		<a href="JavaScript:void(0);" class="view_renewal_history" data-id="<?php echo $row->id;?>" data-rdid=""><i class="fa fa-search-plus"></i></a>
		<?php if($row->is_any_renewal_tagged_with_lead=='N'){ ?>
		&nbsp;
		<a class="icon-btn custom-tooltip tooltipstered renewal_delete text-danger" href="JavaScript:void(0)" data-id="<?php echo $row->id; ?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
		<?php } ?>
	</td>
</tr>
