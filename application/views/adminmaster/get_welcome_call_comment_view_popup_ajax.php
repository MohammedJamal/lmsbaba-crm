<form id="clientForm" name="clientForm">
    ...
    <input type="hidden" name="service_name" id="service_name" value="<?php echo $client_row[0]['service_name']; ?>" />
    <input type="hidden" name="module_name" id="module_name" value="<?php echo $client_row[0]['module_name']; ?>" />
    ...
    <div class="form-group">
        <label for="update_type_id"><b class="text-primary">Update Type:</b> &nbsp; </label>
    ...
    <div class="form-group" id="shownxt_flwdate">
        <label for="comment"><b class="text-primary">Next Followup Date:</b></label>
        <input type="text" id="followup_date" name="followup_date" class="form-control" value="">
    </div>
    <div class="form-group">
        <label for="comment"><b class="text-primary">Comments:</b></label>
    ...
    <div class="form-group">
        <button type="button" class="btn btn-primary" id="call_comment_confirm">Save</button>
    </div>
