<form id="clientForm" name="clientForm">
    ...
    <b>No. of Users Tagged:</b> <?php echo $client_row[0]['total_user_count']; ?><br>
    <b>Module Name:</b> <?php echo $client_row[0]['module_name']; ?><br>
    <b>Service Name:</b> <?php echo $client_row[0]['service_name']; ?><br>
    <b>Service Start Date:</b> <?php echo date_db_format_to_display_format($client_row[0]['start_date']); ?><br>
    <b>Service End Date:</b> <?php echo date_db_format_to_display_format($client_row[0]['package_end_date']); ?><br>
    <b>Service Expiry Date:</b> <?php echo date_db_format_to_display_format($client_row[0]['expire_date']); ?><br>
    ...
    <div class="form-group">
        <button type="button" class="btn btn-primary" id="craete_call_confirm">Create New Call</button>
    </div>
