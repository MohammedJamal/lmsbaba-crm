...
<script type="text/javascript">
    function load(page=1)
    {
        ...
        $.ajax({
        url: base_url + "service_calls/get_all_client_wise_service_list_ajax/"+page,
        data: data,
        cache: false,
        method: 'POST',
        dataType: "html",
...
$("body").on("click",".date_update_confirm",function(e){
    ...
    $.ajax({
    url: base_url + "service_calls/update_expiry_date_ajax",
    data: data,
    cache: false,
    method: 'POST',
    dataType: "html",
...
$("body").on("click",".update_row",function(e){
    ...
    var data="cid="+cid;          
    $.ajax({
    url: base_url + "service_calls/get_client_edit_view_ajax",
    data: data,
    cache: false,
    method: 'POST',
    dataType: "html",
    ...
    $("body").on("click",".tagged_user_list",function(e){
        ...
        $.ajax({
            url: base_url + "service_calls/get_tagged_user_list_ajax",
            data: data,
            cache: false,
            method: 'POST',
            dataType: "html",
    ...
    $("body").on("click","#edit_company_confirm",function(e){
        ...
        var base_url=$("#base_url").val();
        $.ajax({
            url: base_url + "service_calls/save_client_edit_ajax",
...
$("body").on("click",".view_comment_list",function(e){
    ...
    $.ajax({
    url: base_url + "service_calls/get_client_wise_comment_log_list_ajax",
    data: data,
    cache: false,
    method: 'POST',
    dataType: "html",
...
$("body").on("click",".call_comment_update_row",function(e){
    ...
    $.ajax({
    url: base_url + "service_calls/get_call_comment_view_ajax",
    data: data,
    cache: false,
    method: 'POST',
    dataType: "html",
...
$("body").on("click","#call_comment_confirm",function(e){
    var base_url=$("#base_url").val();
    $.ajax({
        url: base_url + "service_calls/save_call_comment_update_ajax",
        data: new FormData($('#clientForm')[0]),
        cache: false,
        method: 'POST',
        dataType: "html",
