    ...
    <div class="col-md-12">
        <div class="form-group">
            <!-- <div class="col-md-6">
                ...
                <div class="col-full">
                    <input type="input" readonly class="form-control" name="done_demo_date" id="done_demo_date"  value="<?php echo date('d-m-Y',strtotime($demo_row['0']['demo_date'])); ?>" />
                </div>
            </div> -->
            ...
            <div class="col-md-6">
                ...
                <div class="col-full">
                <input type="text" name="confirm_time"   id="timepickerstarttime" style="background-color:none !important;" class="form-control"/>
                </div>
            </div>
        ...
        <div class="col-md-6">
                <div class="col-full">
        <button type="button" class="btn btn-primary" id="edit_confirm_demo">Save</button>
        </div>
            </div>
    </div>
